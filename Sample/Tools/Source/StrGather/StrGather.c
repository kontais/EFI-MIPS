    ...
    if (String != NULL) {
      ...
      do {
        ...
        if (SecondString != NULL) {
          ...
          _wcscpy (TempString, String);
          _wcscat (TempString, SecondString);
          free (String);
          free (SecondString);
          String = TempString;
        }
  ...
  )
{
  ...
  while (*Language) {
    ...
    // break out.
    //
    _swprintf (WNewList->Str, (strlen (Language) + 1) * sizeof (WCHAR), L"%S", AsciiToUnicode(Language,NULL));
    ...
    while (*From) {
      ...
      if ((_wcslen (From) < LANGUAGE_IDENTIFIER_NAME_LEN) ||
            (
      ...
      _wcsncpy (To, From, LANGUAGE_IDENTIFIER_NAME_LEN);
            ...
            *End = 0;
            ...
            if (*End) {
              ...
              *End = 0;
              ...
              _swprintf (NewList->Str1, (strlen (StringName) + 1) * sizeof (WCHAR), L"%S", AsciiToUnicode(StringName,NULL));
              _swprintf (NewList->Str2, (strlen (ScopeName) + 1) * sizeof (WCHAR), L"%S", AsciiToUnicode(ScopeName,NULL));
