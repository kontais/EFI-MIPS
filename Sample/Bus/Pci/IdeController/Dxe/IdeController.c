...
EFI_DRIVER_ENTRY_POINT (InitializeIdeControllerDriver)
//
// *************************************
...
--*/
{
  ...
  //
  EfiZeroMem (IdePrivateData, sizeof (EFI_IDE_CONTROLLER_PRIVATE_DATA));
...
--*/
{
  ...
  *SupportedModes = EfiLibAllocateZeroPool (sizeof (EFI_ATA_COLLECTIVE_MODE));
  ...
  (*SupportedModes)->PioMode.Mode   = ATA_PIO_MODE_BELOW_2;
