...
#ifndef _LINUX_SERIAL_IO_
#define _LINUX_SERIAL_IO_
#include <sys/types.h>
#include <sys/stat.h>
#include <stdio.h>
#include <stdlib.h>
...
#define LINUX_SERIAL_IO_PRIVATE_DATA_SIGNATURE EFI_SIGNATURE_32 ('L', 'X', 's', 'i')
typedef struct {
  UINT64                    Signature;
...
} LINUX_SERIAL_IO_PRIVATE_DATA;

#define LINUX_SERIAL_IO_PRIVATE_DATA_FROM_THIS(a) \
         CR(a, LINUX_SERIAL_IO_PRIVATE_DATA, SerialIo, LINUX_SERIAL_IO_PRIVATE_DATA_SIGNATURE)

//
// Global Protocol Variables
//
extern EFI_DRIVER_BINDING_PROTOCOL  gLinuxSerialIoDriverBinding;
extern EFI_COMPONENT_NAME_PROTOCOL  gLinuxSerialIoComponentName;
