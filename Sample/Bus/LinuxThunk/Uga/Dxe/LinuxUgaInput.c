...
Abstract:
  ...
  processing is done in a thread kicked off in LinuxUgaImplementation.c
...
EFI_STATUS
EFIAPI
LinuxUgaSimpleTextInReadKeyStroke (
  IN EFI_SIMPLE_TEXT_IN_PROTOCOL          *This,
...
VOID
EFIAPI
LinuxUgaSimpleTextInWaitForKey (
  IN EFI_EVENT          Event,
  IN VOID               *Context
  )
/*++
...
--*/
{
  ...
  //
  Private->SimpleTextIn.Reset         = LinuxUgaSimpleTextInReset;
  Private->SimpleTextIn.ReadKeyStroke = LinuxUgaSimpleTextInReadKeyStroke;
