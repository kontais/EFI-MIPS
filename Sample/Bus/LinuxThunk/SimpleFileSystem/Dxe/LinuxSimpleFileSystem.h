...
#ifndef _LINUX_SIMPLE_FILE_SYSTEM_H_
#define _LINUX_SIMPLE_FILE_SYSTEM_H_
...
#define LINUX_SIMPLE_FILE_SYSTEM_PRIVATE_SIGNATURE EFI_SIGNATURE_32 ('L', 'X', 'f', 's')
...
} LINUX_SIMPLE_FILE_SYSTEM_PRIVATE;

#define LINUX_SIMPLE_FILE_SYSTEM_PRIVATE_DATA_FROM_THIS(a) \
  CR (a, \
      LINUX_SIMPLE_FILE_SYSTEM_PRIVATE, \
      SimpleFileSystem, \
      LINUX_SIMPLE_FILE_SYSTEM_PRIVATE_SIGNATURE \
      )

#define LINUX_EFI_FILE_PRIVATE_SIGNATURE EFI_SIGNATURE_32 ('l', 'o', 'f', 's')
...
} LINUX_EFI_FILE_PRIVATE;

#define LINUX_EFI_FILE_PRIVATE_DATA_FROM_THIS(a) \
  CR (a, \
      LINUX_EFI_FILE_PRIVATE, \
      EfiFile, \
      LINUX_EFI_FILE_PRIVATE_SIGNATURE \
      )

//
// Global Protocol Variables
//
extern EFI_DRIVER_BINDING_PROTOCOL  gLinuxSimpleFileSystemDriverBinding;
extern EFI_COMPONENT_NAME_PROTOCOL  gLinuxSimpleFileSystemComponentName;
...
#endif /* _LINUX_SIMPLE_FILE_SYSTEM_H_ */

/* eof - LinuxSimpleFileSystem.h */
