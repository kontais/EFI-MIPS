...
EFI_STATUS
EFIAPI
LinuxBlockIoDriverDiagnosticsRunDiagnostics (
...
//
EFI_DRIVER_DIAGNOSTICS_PROTOCOL gLinuxBlockIoDriverDiagnostics = {
  LinuxBlockIoDriverDiagnosticsRunDiagnostics,
  LANGUAGESUPPORTED
};
  ...
  *BufferSize = 0;
  if (DiagnosticType != EfiDriverDiagnosticTypeStandard) {
    ...
    *BufferSize = 0x60;
    ...
    EfiCopyMem (*Buffer, L"Linux Block I/O Driver Diagnostics Failed\n", *BufferSize);
