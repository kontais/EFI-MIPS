...
EFI_STATUS
EFIAPI
LinuxBlockIoDriverConfigurationSetOptions (
...
EFI_STATUS
EFIAPI
LinuxBlockIoDriverConfigurationOptionsValid (
  IN  EFI_DRIVER_CONFIGURATION_PROTOCOL               *This,
  IN  EFI_HANDLE                                      ControllerHandle,
  IN  EFI_HANDLE                                      ChildHandle  OPTIONAL
  );
...
EFI_STATUS
EFIAPI
LinuxBlockIoDriverConfigurationForceDefaults (
  IN  EFI_DRIVER_CONFIGURATION_PROTOCOL                      *This,
  IN  EFI_HANDLE                                             ControllerHandle,
  IN  EFI_HANDLE                                             ChildHandle  OPTIONAL,
...
//
EFI_DRIVER_CONFIGURATION_PROTOCOL gLinuxBlockIoDriverConfiguration = {
  LinuxBlockIoDriverConfigurationSetOptions,
  LinuxBlockIoDriverConfigurationOptionsValid,
  LinuxBlockIoDriverConfigurationForceDefaults,
  LANGUAGESUPPORTED
