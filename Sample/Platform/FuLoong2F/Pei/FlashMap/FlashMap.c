...
static EFI_FLASH_AREA_DATA    mFlashAreaData[] = {
  ...
  //
  {
    EFI_LINUX_FTW_SPARE_BLOCK_OFFSET,
    EFI_LINUX_FTW_SPARE_BLOCK_LENGTH,
    EFI_FLASH_AREA_SUBFV | EFI_FLASH_AREA_MEMMAPPED_FV,
  ...
  //
  {
    EFI_LINUX_FIRMWARE_OFFSET,
    EFI_LINUX_FIRMWARE_LENGTH,
  ...
  //
  {
    EFI_LINUX_RUNTIME_UPDATABLE_OFFSET,
    EFI_LINUX_RUNTIME_UPDATABLE_LENGTH + EFI_LINUX_FTW_SPARE_BLOCK_LENGTH,
    EFI_FLASH_AREA_FV | EFI_FLASH_AREA_MEMMAPPED_FV,
...
// TODO:    EFI_SUCCESS - add return value to function comment
{
  ...
  //
  Status = LinuxFwhPpi->LinuxFwh (0, &FdBase, &FdSize);
  if (EFI_ERROR (Status)) {
    return Status;
  }
  //
