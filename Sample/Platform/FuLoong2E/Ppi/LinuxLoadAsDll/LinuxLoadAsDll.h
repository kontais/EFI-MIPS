...
Abstract:
  ...
  Linux service Ppi that is used to load PE32s in the NT emulation environment.

--*/

#ifndef _LINUX_LOAD_AS_DLL_H_
#define _LINUX_LOAD_AS_DLL_H_

#include "Tiano.h"

#define EFI_LINUX_LOAD_AS_DLL_PPI_GUID \
  { \
...
--*/
typedef struct {
  EFI_LINUX_LOAD_AS_DLL  Entry;
  EFI_LINUX_FREE_LIBRARY FreeLibrary;
} EFI_LINUX_LOAD_AS_DLL_PPI;

extern EFI_GUID gEfiLinuxLoadAsDllPpiGuid;
