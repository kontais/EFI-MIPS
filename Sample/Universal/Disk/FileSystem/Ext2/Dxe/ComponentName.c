...
EFI_UNICODE_STRING_TABLE mExt2DriverNameTable[] = {
  {
    "eng",
    L"EXT2 Simple File System Driver"
  },
  {
    NULL,
    NULL
...
EFI_UNICODE_STRING_TABLE mExt2ControllerNameTable[] = {
  {
    "eng",
    L"EXT2 File System"
  },
  ...
  )
{
  return EfiLibLookupUnicodeString (
          Language,
          gExt2ComponentName.SupportedLanguages,
