...
--*/
{
  ...
  SystemTable->RuntimeServices->GetTime       = LinuxGetTime;
  SystemTable->RuntimeServices->SetTime       = LinuxSetTime;
  SystemTable->RuntimeServices->GetWakeupTime = LinuxGetWakeupTime;
  SystemTable->RuntimeServices->SetWakeupTime = LinuxSetWakeupTime;
