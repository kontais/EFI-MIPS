...
// This is a special entry point for EFI dynamic-load modules
int PyArg_ParseEfi(PyObject *args, char *format, va_list va)
{
	return vgetargs1(args, format, &va, 1);
}
/*
int PyArg_VaParseTupleAndKeywords(PyObject *args, PyObject *keywords, char *format, char **kwlist, va_list *p_va)
{
    return vgetargskeywords(args, keywords, format, kwlist, p_va);
}*/
