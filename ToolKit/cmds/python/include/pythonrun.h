...
#else
typedef int (EFIAPI **pPYOS_INPUT_HOOK) (void);
typedef char * (EFIAPI **pPYOS_READLINE_FUNCTION_POINTER) (FILE *, FILE *, char *);
pPYOS_INPUT_HOOK                pPyOS_InputHook;
pPYOS_READLINE_FUNCTION_POINTER pPyOS_ReadlineFunctionPointer;
#define PyOS_InputHook                  (*pPyOS_InputHook)
#define PyOS_ReadlineFunctionPointer    (*pPyOS_ReadlineFunctionPointer)
#endif
