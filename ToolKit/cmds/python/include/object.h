...
#else
PyAPI_DATA(PyTypeObject) *pPyType_Type; /* built-in 'type' */
PyAPI_DATA(PyTypeObject) *pPyBaseObject_Type; /* built-in 'object' */
PyAPI_DATA(PyTypeObject) *pPySuper_Type; /* built-in 'super' */
#define PyType_Type         (*pPyType_Type)
#define PyBaseObject_Type   (*pPyBaseObject_Type)
#define PySuper_Type        (*pPySuper_Type)

#define PyType_Check(op) PyObject_TypeCheck(op, pPyType_Type)
#define PyType_CheckExact(op) ((op)->ob_type == pPyType_Type)
#endif
...
#else
PyAPI_DATA(long) *_pPy_RefTotal;
#define _Py_RefTotal (*_pPy_RefTotal)
#endif
...
#else
PyAPI_DATA(PyObject) *_pPy_NoneStruct;
#define _Py_NoneStruct (*_pPy_NoneStruct)
#define Py_None (_pPy_NoneStruct)
#endif
...
#else
PyAPI_DATA(PyObject) *_pPy_NotImplementedStruct;
#define _Py_NotImplementedStruct *_pPy_NotImplementedStruct;
#define Py_NotImplemented (_pPy_NotImplementedStruct)
#endif
