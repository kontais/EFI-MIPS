...
#else
PyAPI_DATA(PyTypeObject) *pPyBaseString_Type;
PyAPI_DATA(PyTypeObject) *pPyString_Type;

#define PyBaseString_Type (*pPyBaseString_Type)
#define PyString_Type     (*pPyString_Type)
#endif
