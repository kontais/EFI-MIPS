...
#else
PyAPI_DATA(PyTypeObject) *pPyClass_Type, *pPyInstance_Type, *pPyMethod_Type;
#define PyClass_Type    (*pPyClass_Type)
#define PyInstance_Type (*pPyInstance_Type)
#define PyMethod_Type   (*pPyMethod_Type)
#endif
