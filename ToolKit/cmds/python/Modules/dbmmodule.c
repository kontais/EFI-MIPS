 ...
 */
/* EFI Toolkit: There is always a ndbm.h in TOOLKIT\include\bsd\ */
#if defined(HAVE_NDBM_H) || defined(EFI32) || defined(EFI64) || defined(EFIX64)
#include <ndbm.h>
...
struct _inittab Efi_InitTab = { "dbm", initdbm };
#endif
