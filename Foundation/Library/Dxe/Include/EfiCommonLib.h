...
Routine Description:
  ...
  Convert a Null-terminated ASCII string to a Null-terminated
  ASCII string and returns the Unicode string.
  
Arguments: 
  
  Source       - Null-terminated Ascii string.
  Destination  - Null-terminated Unicode string.
...
Arguments: 
  ...
  Source       - Null-terminated Unicode string.
  Destination  - Null-terminated Ascii string.
